  ...
  return (
    <div className="flex-shrink-0 w-[320px] bg-white rounded-xl overflow-hidden border border-gray-200 hover:shadow-lg transition-shadow">
      <div className="relative h-[200px] group">
        ...
        {promoText && (
          <div className="absolute bottom-0 left-0 right-0 bg-blue-600 text-white text-xs font-semibold text-center py-2">
            {promoText}
          </div>
        )}
      ...
      <div className="p-4">
        ...
        <p className="text-sm text-blue-600 mb-3">{installment}</p>
        ...
        {buttonType === "view" ? (
          <Button variant="outline" className="w-full text-blue-600 border-blue-600 hover:bg-blue-50 bg-transparent">
