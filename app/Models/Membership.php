...
class Membership extends Model
{
    ...
    public function getFormattedHighlightAttribute()
    {
        ...
        return "{$quantity} highlight/{$duration} {$period}";
    }
    ...
    /**
     * Relasi ke AgenCredit
     */
    public function agenCredits()
    {
        return $this->hasMany(AgenCredit::class);
    }

    /**
     * Scope untuk membership highlight
     */
    public function scopeHighlight($query)
    {
        return $query->where('jenis', 'highlight');
    }

    /**
     * Scope untuk membership agen
     */
    public function scopeAgen($query)
    {
        return $query->where('jenis', 'agen');
    }

    /**
     * Scope untuk membership developer
     */
    public function scopeDeveloper($query)
    {
        return $query->where('jenis', 'developer');
    }
}