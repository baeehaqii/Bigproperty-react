...
export function Hero() {
    ...
    const slides = [
        '/placeholder-1.svg?height=500&width=1200',
        '/placeholder-2.svg?height=500&width=1200',
        '/placeholder-3.svg?height=500&width=1200',
    ]
    ...
    return (
        <section className="relative min-h-[480px] overflow-hidden bg-gradient-to-br from-blue-600 via-blue-500 to-blue-400 rounded-2xl">
            ...
            <div className="relative z-10 flex min-h-[480px] flex-col items-center justify-center px-6 py-16">
                <div className="w-full max-w-5xl text-center">
                    <h1 className="mb-4 text-center text-4xl md:text-5xl font-extrabold text-white">#FindYourWayHome</h1>
                        ...
                        <div className="relative rounded-lg bg-white p-2 shadow-lg">
                            <div className="flex items-center gap-2">
                                ...
                                <div className="relative">
                                    <DropdownMenu open={isDropdownOpen} onOpenChange={setIsDropdownOpen}>
                                        ...
                                        <DropdownMenuContent align="start" className="w-32">
                                            ...
                                            >
                                                Beli
                                                {searchType === "Beli" && <div className="h-2 w-2 rounded-full bg-blue-600" />}
                                            </DropdownMenuItem>
                                            <DropdownMenuItem
                                                onClick={() => {
                                                    setSearchType("Sewa")
                                            ...
                                            >
                                                Sewa
                                                {searchType === "Sewa" && <div className="h-2 w-2 rounded-full bg-blue-600" />}
                                            </DropdownMenuItem>
                                        </DropdownMenuContent>
                                    </DropdownMenu>
                                </div>
                                ...
                                <div className="flex flex-1 items-center gap-2">
                                    ...
                                    />
                                    <Button size="icon" className="bg-blue-600 hover:bg-blue-700 text-white rounded-[30px] p-3">
